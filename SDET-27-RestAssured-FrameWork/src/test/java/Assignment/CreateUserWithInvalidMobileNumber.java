...
public class CreateUserWithInvalidMobileNumber {
	@Test
	public void create() {
		int randomNumber = new Random().nextInt(500);
		String proName = "nithesh"+randomNumber;
		PojoClassEmployee pojo = new PojoClassEmployee("SDET", "25/05/1999", "nithesh@gmail.com", proName, 15, 9888777657111L , "hdfc", "ROLE_ADMIN", "nithesh" );
